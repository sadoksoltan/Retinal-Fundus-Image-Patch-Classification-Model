It is important to emphasize that for all the tests carried out, we used the CNN algorithm with different layers and tested several of the best-known architectures.
